...
export class ExerciseFormDialogComponent {
  ...
  readonly difficultyOptions = toPrimeOptions(DIFFICULTY_CATALOG);
  ...
  readonly difficultyLabel = (id: string) => labelById(DIFFICULTY_CATALOG, id);
  ...
  readonly form: FormGroup = this.fb.group({
    ...
    difficulty: [this.exercise?.difficulty ?? 'beginner', Validators.required],
    exerciseCategory: [
    ...
    alternativeExercises: [this.exercise?.alternativeExercises ?? []],
  ...
  /** No-op completeMethod for AutoComplete used in free-form tag mode. */

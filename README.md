...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/RrxkVqR2x3)
...
```sh
npx nx serve adrian-badilla
```

To create a production bundle:

```sh
npx nx build adrian-badilla
```

To see all available targets to run for a project, run:

```sh
npx nx show project adrian-badilla
```
